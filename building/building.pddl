(define (domain building)
	...
	(:action board
        ...
        :precondition (and (person-on-floor ?p ?f) (lift-on-floor ?l ?f) (next ?num1 ?num2) (people-on-lift ?l ?num1))
        :effect (and (not (person-on-floor ?p ?f))(person-on-lift ?p ?l)(not (people-on-lift ?l ?num1)) (people-on-lift ?l ?num2)
    ))
	
	(:action leave
        :parameters (?p -person ?f -number ?l -lift ?num1 ?num2 -number)
        :precondition (and (person-on-lift ?p ?l) (lift-on-floor ?l ?f) (next ?num2 ?num1) (people-on-lift ?l ?num1))
        :effect (and (person-on-floor ?p ?f)(not (person-on-lift ?p ?l))(not (people-on-lift ?l ?num1)) (people-on-lift ?l ?num2)
    ))
)
